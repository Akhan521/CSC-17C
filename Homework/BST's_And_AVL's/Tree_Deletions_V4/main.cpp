 ...
 * File:    main.cpp
 * Author:  Aamir Khan
 * Created: November 16, 2022, 1:45 PM
 * Purpose: Deleting nodes in our tree.
 */
...
int main(int argc, char** argv) {
    ...
    prntIn(root);
    cout<<endl;
    cout<<"\nDeleting "<<nNodes/2<<" nodes: "<<endl;
    for(int i=1;i<=nNodes/2;i++){
        //To hold the value we'd like to delete.
        int target;
        //Prompting the user for a value to delete.
        cout<<"What value would you like to delete? ";
        cin>>target;
        //Deleting the chosen value from our tree if it exists.
        delNode(root,target);
        //Outputting our updated tree.
        cout<<"\nIn-Order Traversal:\n";
        prntIn(root);
        cout<<endl;
    }
