 ...
 * File:    main.cpp
 * Author:  Aamir Khan
 * Created: November 16, 2022, 7:05 PM
 * Purpose: Balancing our tree after every insertion/deletion.
 */
...
int main(int argc, char** argv) {
    ...
    //Creating and filling our tree w/ the values 1-10.
    Node *root=NULL; //Our root node.
    cout<<"Inserting Nodes:\n";
    cout<<"----------------\n";
    for(int i=1;i<=10;i++){
        //Inserting a new node into our tree.
        insert(root,i);
    ...
    //Deleting all nodes in our tree 1-by-1.
    cout<<"Deleting Nodes:\n";
    cout<<"---------------\n";
    for(int i=1;i<=10;i++){
        //Deleting a node from our tree.
        cout<<"Deleting: "<<i<<endl;
        delNode(root,i);
        //If the tree isn't empty, we display it.
        if(root!=NULL){
            cout<<"Level-Order Traversal:\n";
            prntLvl(root);
            cout<<"\nHeight = "<<height(root);
