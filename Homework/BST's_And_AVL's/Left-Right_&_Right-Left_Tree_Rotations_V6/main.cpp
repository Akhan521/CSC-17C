 ...
 * File:    main.cpp
 * Author:  Aamir Khan
 * Created: November 16, 2022, 6:35 PM
 * Purpose: Left-right and right-left tree rotations.
 */
...
int main(int argc, char** argv) {
    ...
    //Demonstrating a left-right rotation:
    cout<<"Left-Right Rotation Example:"<<endl;
    cout<<"----------------------------"<<endl;
    ...
    //Demonstrating a right-left rotation:
    cout<<"\nRight-Left Rotation Example:"<<endl;
    cout<<"----------------------------"<<endl;
